...
import sys
sys.path.append("../")
from PSOfuncs import CausalPSO
from PSOfuncs import score_DAG
import utils
...
def main():
    ...
    t = time.perf_counter()
    edge_array, partition, bic = CausalPSO(samples, PSO_iterations, PSO_particles)

    print(f"Ran MCMC for {PSO_iterations} iterations")
